...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-white/10 bg-background p-6 shadow-[0_20px_60px_rgba(0,0,0,0.45)] sm:rounded-xl duration-200',
        ...
        'data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg font-sans',
        className,
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-lg font-semibold leading-none tracking-tight text-foreground-lighter mb-2',
      className,
    )}
    {...props}
  />
