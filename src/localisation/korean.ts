...
const KOREAN: Translations = {
  ...
  [Phrase.KillVideoDuplicate]: 'Duplicate',
  [Phrase.KillVideoMusicLabel]: 'Music',
  [Phrase.KillVideoMusicDropHint]: 'Drop audio files here (MP3, WAV, OGG, FLAC, M4A)',
  [Phrase.KillVideoMusicRemove]: 'Remove',
  [Phrase.Reset]: '초기화',
  [Phrase.Render]: '렌더링',
