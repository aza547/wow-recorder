...
const KOREAN: Translations = {
  ...
  [Phrase.LockFilterLabel]: "잠금 필터",
  [Phrase.ShowLockedOnlyTooltip]: "잠긴 동영상만 표시합니다.",
  [Phrase.ShowUnlockedOnlyTooltip]: "잠금 해제된 동영상만 표시합니다.",
  [Phrase.ShowAllLocksTooltip]: "잠긴 동영상과 잠금 해제된 동영상을 모두 표시합니다.",
  [Phrase.GuildNoPermission]: "이 작업을 수행하기 위한 권한이 없습니다.",
  [Phrase.RemoveTagFromList]: "목록에서 %value%를 제거합니다.",
  [Phrase.DisabledDueToFilter]: "현재 선택한 필터로 인해 비활성화되었습니다.",
