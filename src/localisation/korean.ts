...
const KOREAN: Translations = {
  ...
  [Phrase.TimestampMarkerEnabledDescription]: '녹화 중 중요한 순간을 표시하는 단축키 활성화',
  [Phrase.TimestampMarkerKeyDescription]: '타임스탬프 표시에 사용할 키',
  [Phrase.TimestampMarkerMouseButtonDescription]: '타임스탬프 표시에 사용할 마우스 버튼',
  [Phrase.TimestampMarkerModifiersDescription]: '타임스탬프 표시와 함께 사용할 수식어 키',
  [Phrase.TimestampMarkerLabel]: '타임스탬프 마커',
  [Phrase.TimestampMarkerHotkeyLabel]: '타임스탬프 마커 단축키',
  [Phrase.TimestampMarkerTooltip]: '녹화 중 중요한 순간 표시하기',
  [Phrase.TimestampMarkerNavigateTooltip]: '타임스탬프 마커 사이 이동',
  [Phrase.TimestampMarkers]: '타임스탬프 마커',
  [Phrase.PreviousMarker]: '이전 마커',
  [Phrase.NextMarker]: '다음 마커',
  [Phrase.NoTimestampMarkers]: '타임스탬프 마커 없음',
