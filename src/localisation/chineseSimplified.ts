...
const CHINESE_SIMPLIFIED: Translations = {
  ...
  [Phrase.LockFilterLabel]: "锁定筛选器",
  [Phrase.ShowLockedOnlyTooltip]: "仅显示已锁定的视频。",
  [Phrase.ShowUnlockedOnlyTooltip]: "仅显示未锁定的视频。",
  [Phrase.ShowAllLocksTooltip]: "显示已锁定和未锁定的视频。",
  [Phrase.GuildNoPermission]: "公会权限不足，无法执行此操作。",
  [Phrase.RemoveTagFromList]: "从列表中删除 %value%",
  [Phrase.DisabledDueToFilter]: "由于当前选择的过滤器而被禁用。",
