...
const GERMAN: Translations = {
  ...
  [Phrase.LockFilterLabel]: "Sperrfilter",
  [Phrase.ShowLockedOnlyTooltip]: "Nur gesperrte Videos anzeigen.",
  [Phrase.ShowUnlockedOnlyTooltip]: "Nur entsperrte Videos anzeigen.",
  [Phrase.ShowAllLocksTooltip]: "Gesperrte und entsperrte Videos anzeigen.",
  ...
  [Phrase.DisabledDueToFilter]: "Aufgrund der aktuell ausgewählten Filter deaktiviert.",
