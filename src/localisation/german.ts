...
const GERMAN: Translations = {
  ...
  [Phrase.MinMopChallengeTierDescription]: 'Ob Mists of Pandaria Classic Herausforderungsmodi aufgenommen werden sollen.',
  ...
  [Phrase.MinimumMopChallengeTierLabel]: 'MoP Herausforderungsmodi aufnehmen',
