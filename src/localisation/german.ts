...
const GERMAN: Translations = {
  ...
  [Phrase.MopChallengeModeDescription]: 'Ob Mists of Pandaria Classic Herausforderungsmodi aufgenommen werden sollen.',
  ...
  [Phrase.MopChallengeModeLabel]: 'MoP Herausforderungsmodi aufnehmen',
