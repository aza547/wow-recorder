...
const GERMAN: Translations = {
  ...
  [Phrase.SeparateAudioTracksLabel]: 'Separate Spuren',
  ...
  [Phrase.SeparateAudioTracksDescription]: "Wähle aus, auf welchen Spuren jede Audioquelle aufgenommen wird. Spur 1 enthält standardmäßig den vollständigen Mix.",
