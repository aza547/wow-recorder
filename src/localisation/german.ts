...
const GERMAN: Translations = {
  ...
  [Phrase.TimestampMarkerEnabledDescription]: 'Hotkey aktivieren, um wichtige Momente während der Aufnahme zu markieren',
  [Phrase.TimestampMarkerKeyDescription]: 'Taste zum Markieren von Zeitstempeln',
  [Phrase.TimestampMarkerMouseButtonDescription]: 'Maustaste zum Markieren von Zeitstempeln',
  [Phrase.TimestampMarkerModifiersDescription]: 'Zusatztasten für die Zeitstempel-Markierung',
  [Phrase.TimestampMarkerLabel]: 'Zeitstempel-Markierungen',
  [Phrase.TimestampMarkerHotkeyLabel]: 'Zeitstempel-Markierung Hotkey',
  [Phrase.TimestampMarkerTooltip]: 'Wichtige Momente während der Aufnahme markieren',
  [Phrase.TimestampMarkerNavigateTooltip]: 'Zwischen Zeitstempel-Markierungen navigieren',
  [Phrase.TimestampMarkers]: 'Zeitstempel-Markierungen',
  [Phrase.PreviousMarker]: 'Vorherige Markierung',
  [Phrase.NextMarker]: 'Nächste Markierung',
  [Phrase.NoTimestampMarkers]: 'Keine Zeitstempel-Markierungen',
