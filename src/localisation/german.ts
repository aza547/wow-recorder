...
const GERMAN: Translations = {
  ...
  [Phrase.CloudUploadDeleteAfterUploadDescription]: 'Lokale Videos ausblenden, solange sie zum Upload eingereiht sind, und die lokale Kopie nach erfolgreichem Upload löschen.',
  ...
  [Phrase.CloudUploadDeleteAfterUploadLabel]: 'Nach Upload löschen',
