...
const ENGLISH: Translations = {
  ...
  [Phrase.CloudUploadDeleteAfterUploadDescription]: 'Hide local videos while they are queued for upload, then delete the local copy after a successful upload.',
  ...
  [Phrase.CloudUploadDeleteAfterUploadLabel]: 'Delete After Upload',
