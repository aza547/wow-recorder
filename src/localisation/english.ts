...
const ENGLISH: Translations = {
  ...
  [Phrase.MinMopChallengeTierDescription]: 'Whether to record Mists of Pandaria Classic challenge modes.',
  ...
  [Phrase.MinimumMopChallengeTierLabel]: 'Record MoP Challenge Modes',
