...
const ENGLISH: Translations = {
  ...
  [Phrase.TbcLogPathDescription]: 'Location of the World of Warcraft logs folder for your TBC Anniversary installation, e.g. "C:\\Program Files (x86)\\World of Warcraft\\_anniversary_\\Logs".',
  ...
  [Phrase.RecordTbcDescription]: 'Whether the application should record TBC Anniversary.',
  ...
  [Phrase.RecordTbcLabel]: 'Record TBC Anniversary',
  [Phrase.TbcLogPathLabel]: 'TBC Anniversary Log Path',
  ...
  [Phrase.InvalidTbcLogPathText]: 'Invalid TBC Anniversary log path.',
  ...
  [Phrase.InvalidTbcLogPath]: 'Invalid TBC Anniversary log path.',
