...
const ENGLISH: Translations = {
  ...
  [Phrase.SeparateAudioTracksLabel]: 'Separate Tracks',
  ...
  [Phrase.SeparateAudioTracksDescription]: "Choose which tracks record each audio source. Track 1 contains the full mix by default.",
