...
const ENGLISH: Translations = {
  ...
  [Phrase.PushToTalkDescription]: 'Enable push to talk for microphone input',
  [Phrase.PushToTalkKeyDescription]: 'Key to use for push to talk',
  [Phrase.PushToTalkMouseButtonDescription]: 'Mouse button to use for push to talk',
  [Phrase.PushToTalkModifiersDescription]: 'Modifier keys to use with push to talk',

  // Timestamp marker translations
  [Phrase.TimestampMarkerEnabledDescription]: 'Enable hotkey to mark important moments during recording',
  [Phrase.TimestampMarkerKeyDescription]: 'Key to use for marking timestamps',
  [Phrase.TimestampMarkerMouseButtonDescription]: 'Mouse button to use for marking timestamps',
  [Phrase.TimestampMarkerModifiersDescription]: 'Modifier keys to use with timestamp marker',
  [Phrase.TimestampMarkerLabel]: 'Timestamp Markers',
  [Phrase.TimestampMarkerHotkeyLabel]: 'Timestamp Marker Hotkey',
  [Phrase.TimestampMarkerTooltip]: 'Mark important moments during recording',
  [Phrase.TimestampMarkerNavigateTooltip]: 'Navigate between timestamp markers',
  [Phrase.TimestampMarkers]: 'Timestamp Markers',
  [Phrase.PreviousMarker]: 'Previous Marker',
  [Phrase.NextMarker]: 'Next Marker',
  [Phrase.NoTimestampMarkers]: 'No timestamp markers',
