...
const ENGLISH: Translations = {
  ...
  [Phrase.LockFilterLabel]: "Lock Filter",
  [Phrase.ShowLockedOnlyTooltip]: "Show locked videos only.",
  [Phrase.ShowUnlockedOnlyTooltip]: "Show unlocked videos only.",
  [Phrase.ShowAllLocksTooltip]: "Show locked and unlocked videos.",
  ...
  [Phrase.DisabledDueToFilter]: "Disabled due to currently selected filters.",
